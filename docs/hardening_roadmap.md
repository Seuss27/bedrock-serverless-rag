...
| **S1a** | **Pipeline hardening — the gate** *(T5 alone; split out 2026-08-08)* | **F13, F14, F20**, and the `paths:`/`name:` half of **F18** | planned |
| **S1b** | **Pipeline hardening — the rewrite** *(T2 → T1 → T4 → T3 → T6 → T7)* | F15, F16, F19, F21, rest of F18 | planned |
...
> `S1b`.** The one part of F18 that moved task is called out in the sprint table above: its
