...
| **MW** | **Make it work** — the first successful `destroy → apply → verify` cycle | **F51**, F39, F5, F46, F55 | **in progress** (Tasks 1–5 done; Task 6 remains) |
