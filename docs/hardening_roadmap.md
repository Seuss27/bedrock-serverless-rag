...
| **ST** | **Organization transfer** — `Seuss27/` → `glunk-works/` | F44, **F45 (by removal — see the 2026-08-06 log entry)**, F50, the `path` half of F57, and the ST-T1 half of F40. *(**F58** and F57's boundary half → **S2-T0**; **F55** → **MW-T0**; **F56** → **S2-T0**.)* | **done** *(2026-08-07)* |
